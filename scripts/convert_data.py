...
CSV_FILES = {
    'western_han.csv': ['西漢', '漢朝'],
    'xin.csv': ['新', '漢朝'],
    'gengshi.csv': ['更始', '漢朝'],
    'xin_gengshi_others.csv': ['', ''],
    'eastern_han.csv': ['東漢', '漢朝'],
    'eastern_han_others.csv': ['', ''],
    'cao_wei.csv': ['曹魏', '三國'],
    'cao_wei_others.csv': ['', ''],
    'shu_han.csv': ['蜀漢', '三國'],
    'sun_wu.csv': ['孫吳', '三國'],
    'western_jin.csv': ['西晉', '晉朝'],
    'western_jin_others.csv': ['', ''],
    'eastern_jin.csv': ['東晉', '晉朝'],
    ...
    'liu_song.csv': ['劉宋', '南北朝'],
    'liu_song_others.csv': ['', ''],
    'southern_qi.csv': ['南齊', '南北朝'],
    'southern_qi_others.csv': ['', ''],
    'xiao_liang.csv': ['南梁', '南北朝'],
    'xiao_liang_others.csv': ['', ''],
    'western_xiao_liang.csv': ['西梁', '南北朝'],
    'southern_chen.csv': ['南陳', '南北朝'],
    'northern_wei.csv': ['北魏', '南北朝'],
    'northern_wei_others.csv': ['', '南北朝'],
    'eastern_wei.csv': ['東魏', '南北朝'],
    'eastern_wei_others.csv': ['', ''],
    'western_wei.csv': ['西魏', '南北朝'],
    'northern_qi.csv': ['北齊', '南北朝'],
    'northern_qi_others.csv': ['', ''],
    'northern_zhou.csv': ['北周', '南北朝'],
    ...
    'zhu_liang.csv': ['後梁', '五代十國'],
    'zhu_liang_others.csv': ['', ''],
    'hedong.csv': ['河東', '五代十國'],
    'later_tang.csv': ['後唐', '五代十國'],
    'later_jin.csv': ['後晉', '五代十國'],
    'later_jin_others.csv': ['', ''],
    'later_han.csv': ['後漢', '五代十國'],
    'later_zhou.csv': ['後周', '五代十國'],
    'yang_wu.csv': ['吳', '五代十國'],
    ...
    'northern_song.csv': ['北宋', '宋朝'],
    'northern_song_others.csv': ['', ''],
    'southern_song.csv': ['南宋', '宋朝'],
